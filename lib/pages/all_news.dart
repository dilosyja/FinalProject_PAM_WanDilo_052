...
import 'package:final_project/services/news.dart';
import 'package:final_project/services/slider_data.dart';
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(context,
            MaterialPageRoute(builder: (context) => ArticleView(blogUrl: url, title: title)));
      },
      child: Container(
        child: Column(
          children: [
